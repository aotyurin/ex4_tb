...
public class InitBaseDao {
    ...
    public void init() {
        ...
        String sqlCreate__Loss_Order = "CREATE TABLE IF NOT EXISTS Loss_Order(pair TEXT, price REAL, quantity REAL,  type TEXT, created TEXT, priceLoss REAL, PRIMARY KEY (pair, priceLoss));";
